...
#this is how you can use lambda with pandas dataframe column

salary = df['Salary Estimate'].apply(lambda x: x.split('(')[0])
#print(salary.head(5))
# removing k and dollar sign 
...
df['excel_yn'] = df['Job Description'].apply(lambda x: 1 if 'excel_yn' in x.lower() else 0)
